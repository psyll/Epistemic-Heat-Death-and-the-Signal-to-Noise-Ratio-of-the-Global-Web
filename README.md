...
The paper is also explicit about what it doesn't yet know - see §9.5 (falsification conditions), §5.6 (model limitations), and §15 (objections and responses, including a self-directed unfalsifiability objection).
